            ...
            <div className="col-sm-6 col-md-4 col-lg-3" key={p.id}>
              <div className="card shadow-sm h-100">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <p className="card-text text-success fw-semibold">${p.price.toFixed(2)}</p>
                  <div className="d-flex flex-column gap-2 mt-auto">
                    <button className="btn btn-success w-100" onClick={() => handleAddToCart(p)}>
                      Ajouter au panier
                    </button>
                    <button className="btn btn-outline-danger w-100" onClick={() => handleAddToFavorites(p)}>
                      ❤️ Favoris
                    </button>
                  </div>
                </div>
