...
//     <img 
//   src="https://via.placeholder.com/300x200?text=Orange"
//   alt="Orange"
// />
...
//     const productToAdd = {
//       title: product.title,
//       price: `$${product.price.toFixed(2)}`, // Format price as string with $
//       img: product.img,
//     };
...
//         });
//       }
//       addToCart(productToAdd); // Mise à jour du contexte local
//       alert(`${product.title} ajouté au panier !`);
//     } catch (error) {
//       console.error("Erreur ajout panier:", error);
